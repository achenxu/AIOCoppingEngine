...
function init(){
  console.log(chalk.green("Hello Brother, Welcome to AIO Copping Engine. Powered by IceBot"))
  console.log(chalk.yellow('Please Wait.... Downloading Bot Files from the secure encrypted micrsoft secure server'))
  setTimeout(stageTwo, 3500)
}
function stageTwo(){
  console.log(chalk.bgWhite.green('SERVER RESPONDED WITH: 200'))
  console.log(chalk.green('Files Saved'))
  console.log(chalk.yellow('Opening Menu Now'))
  setTimeout(stageThree, 2500)
}
function stageThree(){
  clear()
  console.log(chalk.red('Your Proxies Are Banned Brother, you should have listened to EBotServers, RESIDENTIAL IS A SCAM'))
  process.exit()
}
